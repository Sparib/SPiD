...
app.post("/hook", (req, res) => {
    ...
    res.status(200).end();
    if (!winArray) {
        runnables.sendSingleWebhook(discURL, pollTitle, totalVotes, winOption, winVotes);
    } else {
        runnables.sendMultipleWebhook(discURL, pollTitle, totalVotes, winOption, winVotes);
    }
});
